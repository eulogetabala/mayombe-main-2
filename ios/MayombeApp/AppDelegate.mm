...
#if __has_include(<GoogleMaps/GoogleMaps.h>)
  [GMSServices provideAPIKey:@"AIzaSyBH1IRNXPqsDDfIJItSb3hUJ1Q6gkqAcsI"];
#endif
...
{
  // Passer le device token APNs à Firebase Messaging
  [FIRMessaging messaging].APNSToken = deviceToken;
  NSLog(@"✅ Device token APNs reçu et passé à Firebase Messaging");
...
{
  NSLog(@"❌ Erreur enregistrement notifications distantes: %@", error.localizedDescription);
