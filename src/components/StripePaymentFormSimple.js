...
const StripePaymentFormSimple = ({ 
  ...
  const handlePayPress = async () => {
    ...
    try {
      ...
      console.log('🔍 cardData pour backend:', cardData);

      // Créer le PaymentMethod avec les données manuelles
      ...
      // Appel au backend avec un ID unique
...
export default StripePaymentFormSimple;
