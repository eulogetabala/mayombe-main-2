  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const isSuccess = response.success || 
                       ...
                       response.message?.includes('modifié') ||
                       response.message?.includes('réinitialisé');
      ...
      if (isSuccess) {
        ...
        // Si le message contient "succès" ou "modifié" mais la réponse dit "erreur"
        if (response.message && (response.message.includes('succès') || response.message.includes('modifié'))) {
          Alert.alert(
            "Succès",
            "Votre mot de passe a été réinitialisé avec succès.",
            [
          ...
          Alert.alert("Erreur", response.message || "Erreur de réinitialisation.");
        }
      }
    } catch (error) {
