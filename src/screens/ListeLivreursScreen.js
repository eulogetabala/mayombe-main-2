  ...
  return (
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <>
          {/* Header WOW avec dégradé et animations */}
          <Animatable.View animation="fadeInDown" delay={200} style={styles.wowHeader}>
            <View style={styles.wowHeaderGradient}>
              <View style={styles.wowHeaderContent}>
                <View style={styles.wowHeaderLeft}>
                  <View style={styles.wowHeaderIconContainer}>
                    <Ionicons name="bicycle" size={24} color="#fff" />
                  </View>
                  <View style={styles.wowHeaderText}>
                    <Text style={styles.wowHeaderTitle}>
                      {livreurs.length} livreurs express
                    </Text>
                    <Text style={styles.wowHeaderSubtitle}>
                      {isLoadingLocation 
                ...
                <View style={styles.wowHeaderRight}>
                  <View style={styles.wowPriceBadge}>
                    <Text style={styles.wowPriceBadgeText}>
                      {isLoadingLocation ? (
                        <ActivityIndicator size="small" color="#fff" />
                      ) : (
                        `${deliveryFee} FCFA`
